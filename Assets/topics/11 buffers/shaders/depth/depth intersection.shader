...
{
    Properties {
        _size ("interesection size", Range(0.1, 1)) = 0.2
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag (Interpolators i) : SV_Target
            {
                ...
                float worldDepth = depth / _ProjectionParams.w; // .w is 1/farplane
                // depth comp i.surfZ

                float difference = abs(i.surfZ - worldDepth);
                color = 1-smoothstep(0, _size, difference);
