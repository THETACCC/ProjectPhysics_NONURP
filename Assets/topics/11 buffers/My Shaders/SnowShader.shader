    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag (Interpolators i) : SV_Target
            {
                ...
                //Make the lightDirection Randomzied;
                lightDirection = (rand(lightDirection.x * rand(sin(_Time.z))) ,rand(lightDirection.y + rand(sin(_Time.z))),rand(lightDirection.z) / rand(sin(_Time.z)));
                ...
                // posterization
                diffuse = floor(diffuse * _diffuseLightSteps) / _diffuseLightSteps;
